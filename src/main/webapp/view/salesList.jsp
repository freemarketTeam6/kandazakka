...
<body>
	...
	<div class="searchBox">
		<form action="#">
			年：<input type="text" name="year"> 月：<input type="text"
				name="month"> <input type="submit" value="検索">
		</form>
		<form action="#">
	...
	<table class="listTable">
		...
		<tr>
			...
			<td><img class="img"
				src="<%=request.getContextPath() %>/file/images/<%= salesGoodsList.get(i).getImgPath() %>"
				alt="商品写真"></td>
